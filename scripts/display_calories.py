...
def main():
    ...
    while windowOpen:
        ...
        if (UI_stage == BUTTON_STG):
            left, top = size
            width, height = (140, 40)
            pygame.draw.circle(screen,GREY,(100, 100), 30)
            pygame.draw.circle(screen,GREY,(200, 100), 30)
            pygame.display.flip()

        elif (UI_stage == VIDEO_STG):
            ret, frame = cap.read()
            ...
            # TODO: Send pose image to display
            ...
            # # TODO: If person is falling out of the frame, display warning
            ...
            # # TODO: Display calorie count when calculated
